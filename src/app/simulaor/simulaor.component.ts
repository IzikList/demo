...
import { PolicyLifeCycle, InvestCycle, InvestDetails } from './policyLifeCycle';
...
const staticArr = [];
@Component({
  selector: 'app-simulaor',
  templateUrl: './simulaor.component.html',
  styleUrls: ['./simulaor.component.css'],  animations: [
...
export class SimulaorComponent implements OnInit {
